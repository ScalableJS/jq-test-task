...
watch('$').then(($) => {
    ...
    $mainSectionChildren.eq(0)
        ...
        .find('>section:first')
        .addClass('homepage-poster--content');
    ...
    $('.member-benefit-section span[href]').each(function () {
        ...
        $(`<a class="member-benefit-section--card" href="${href}">${html}</a>`).replaceAll(this);
    });

    $('.member-benefit-section--card')
        .parent()
        .addClass('member-benefit-section--card-list');

    $('.member-experiences-section a:has(h3)')
        .addClass('member-experiences-section--card')
        .parent()
        .addClass('member-experiences-section--card-list');
